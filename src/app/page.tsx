        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link href="/signup" className="cursor-pointer">
              <Button className="text-sm font-bold bg-primary hover:bg-primary/90 text-white">S&apos;inscrire</Button>
            </Link>
          </nav>
        </div>
      </header>
      ...
      <main className="flex-1 container mx-auto px-4 py-12 md:py-24">
        ...
        <section className="w-full flex flex-col items-center text-center">
          <div className="space-y-8 max-w-4xl">
            <h1 className="text-5xl font-black tracking-tighter md:text-7xl text-foreground leading-[1.1]">
            ...
            <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl font-medium leading-relaxed">
              La plateforme ultime pour héberger votre bot. Multi-session, ultra-rapide et sécurisée. Gérez vos automatisations comme jamais auparavant.
            </p>
            <div className="flex gap-4 justify-center pt-8">
              <Link href="/signup" className="cursor-pointer">
                <Button size="lg" className="font-bold gap-2 bg-primary hover:bg-primary/90 text-white">
        ...
        <section id="features" className="w-full py-24">
          <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center space-y-4 p-6 rounded-2xl border border-border bg-card">
